...
**Plans**: 3 plans
  - [ ] 03-01-PLAN.md — Conversion backbone: typed IPC bridge, conversions+conversion_files schema, presets registry, conversionCore + conversionWorker (ffmpeg pool, SIGTERM-first cancel), ConversionController (single-active, heartbeat), folder allowlist gate, tag round-trip integration test
