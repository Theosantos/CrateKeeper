...
**Success Criteria**:
  ...
  3. Tags written for MP3 files use ID3v2.3 with UTF-16 encoding, integer BPM, and Camelot-notation Key — importing into Rekordbox shows the values correctly**Plans**: 3 plans
